...
class DiscordApiClient:
    ...
    def get_channel_info(self, channel_id: str) -> Dict[str, Any]:
        """
        Fetch information about a Discord channel.

        This method retrieves details about a specified Discord channel,
        including its name, type, and other properties.

        Args:
            channel_id (str): The ID of the Discord channel to fetch information for.
